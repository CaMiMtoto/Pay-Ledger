@php use App\Constants\AppPermission; @endphp
    <!DOCTYPE html>
...
<flux:sidebar sticky collapsible="mobile"
    ...
    <flux:sidebar.nav>
        <flux:sidebar.group class="flex flex-col gap-2 mb-3">
            <flux:sidebar.item icon="house" :href="route('admin.dashboard')"
        ...
        <flux:sidebar.group icon="users" expandable heading="User Management" class="grid">
            @can(AppPermission::MANAGE_USERS)
                <flux:sidebar.item :href="route('admin.users.list')" :current="request()->routeIs('admin.users.list')"
                                   wire:navigate>
                    Users
                </flux:sidebar.item>
            @endcan
