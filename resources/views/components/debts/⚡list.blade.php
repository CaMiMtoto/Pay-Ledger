...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        (new DebtService())->save($customer, $this->amount, $this->due_date, $this->description);
        (new TransactionService())->save($customer, $this->amount, 1, now()->toDateString(), $this->description);
    ...
    /**
     * @return Customer[]|Collection|\Illuminate\Support\Collection|\LaravelIdea\Helper\App\Models\_IH_Customer_C
     */
                    ...
                    <flux:table.rows>
                        @forelse ($this->debts as $item)
                            <flux:table.row :key="$item->id">
                                ...
                                <flux:table.cell
                                    class="whitespace-nowrap">{{ $item->due_date->toDateString() }}</flux:table.cell>
            ...
            <div class="space-y-6">
                ...
                <form wire:submit="save" class="space-y-6">
                    <div class="space-y-6">
                        ...
                        <flux:input label="Amount" type="number" wire:model="amount" placeholder="Amount"/>
